              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    Semua data pribadi Anda (profil pengguna, riwayat chat, preferensi) disimpan 
                    secara lokal di browser perangkat Anda menggunakan Local Storage. Data ini 
                    tidak pernah dikirim ke server eksternal atau cloud.
                  </p>
                </div>
                ...
                <div>
                  <h3 className="font-semibold mb-2">Kontrol Penuh oleh Pengguna</h3>
                  <p className="text-gray-600 dark:text-gray-400">
                    Anda memiliki kontrol penuh terhadap data Anda. Kapan saja Anda dapat:
                  </p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    Data yang disimpan di Local Storage mengikuti kebijakan keamanan browser. 
                    Data hanya dapat diakses oleh aplikasi InsurAI dari domain yang sama dan 
                    tidak dapat diakses oleh website atau aplikasi lain.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    InsurAI tidak menggunakan Google Analytics, Facebook Pixel, atau layanan 
                    pelacakan lainnya. Tidak ada data penggunaan yang dikumpulkan atau dikirim 
                    ke pihak ketiga untuk tujuan analisis atau marketing.
                  </p>
                </div>

                <div>
                  <h3 className="font-semibold mb-2">Tanpa Cookies Pelacakan</h3>
                  <p className="text-gray-600 dark:text-gray-400">
                    Aplikasi tidak menggunakan cookies untuk pelacakan atau profiling. Cookies 
                    yang mungkin ada hanya untuk fungsionalitas dasar aplikasi web dan tidak 
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  perubahan dalam aplikasi atau peraturan yang berlaku. Perubahan signifikan 
